...
const CreateUserModal = ({ ...createProps }) => {
  ...
  return (
    <Modal component="div" open={createProps.openCreate} onClose={handleClose}>
      <Box sx={styles.modal}>
        ...
        <FormGroup>
          <FormControl>
            <FormControlLabel
              control={<Switch disabled={guest} onChange={handleChangeAdmin} />}
              label="Admin"
              sx={styles.input}
            />
            <FormControlLabel
              control={<Switch disabled={admin} onChange={handleChangeGuest} />}
              label="Vieras"
              sx={styles.input}
            />
            {admin ? (
